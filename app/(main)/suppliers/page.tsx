      ...
      <div className="bg-surface border border-border rounded-2xl shadow-sm overflow-hidden">
        ...
        <div className="p-5 border-t border-border flex items-center justify-between bg-surface-raised/30">
          ...
          <div className="flex gap-2">
            <button className="w-9 h-9 flex items-center justify-center text-muted border border-border rounded-xl hover:bg-surface-raised transition-all disabled:opacity-20 active:scale-[0.95]" disabled aria-label="หน้าก่อนหน้า">
               <iconify-icon icon="solar:alt-arrow-left-linear" width="18" height="18" aria-hidden="true" />
            </button>
            <button className="w-9 h-9 flex items-center justify-center text-muted border border-border rounded-xl hover:bg-surface-raised transition-all disabled:opacity-20 active:scale-[0.95]" disabled aria-label="หน้าถัดไป">

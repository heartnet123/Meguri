                      ...
                      <>
                        ...
                        {canEdit && (
                          <button
                            ...
                            className="opacity-0 group-hover:opacity-100 focus-visible:opacity-100 text-xs font-medium text-muted hover:text-accent transition-all px-2 py-1.5 rounded-lg hover:bg-accent-subtle"
                        ...
                        {canRemove && (
                          <button
                            ...
                            className="opacity-0 group-hover:opacity-100 focus-visible:opacity-100 text-xs font-medium text-muted hover:text-red-600 transition-all px-2 py-1.5 rounded-lg hover:bg-red-50"

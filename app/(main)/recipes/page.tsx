                    ...
                    <td className="px-6 py-4 text-right">
                      <div className="flex items-center justify-end gap-2 opacity-0 group-hover:opacity-100 focus-within:opacity-100 transition-opacity">
                        <button
                          ...
                          className="p-2 text-muted hover:text-accent hover:bg-accent-subtle rounded-lg transition-all focus:outline-none focus:ring-2 focus:ring-accent"
                          title="แก้ไขสินค้า"
                          aria-label="แก้ไข"
                        >
                        ...
                        <button
                          ...
                          className="p-2 text-muted hover:text-danger hover:bg-danger-subtle rounded-lg transition-all focus:outline-none focus:ring-2 focus:ring-danger"
                          title="ลบสินค้า"
                          aria-label="ลบ"
                        >

...
export default function SellableItemsPage() {
  ...
  return (
    <div className="space-y-6 max-w-7xl mx-auto">
      ...
      <div className="rounded-2xl border border-border bg-surface p-4 shadow-sm relative">
        <iconify-icon
          icon="solar:magnifer-linear"
          width="18" height="18"
          className="absolute left-7 top-1/2 -translate-y-1/2 text-muted pointer-events-none"
          aria-hidden="true"
        />
        <input
          type="search"
          ...
          aria-label="ค้นหาสินค้าพร้อมขาย"
          className="w-full rounded-xl border border-border bg-background py-2.5 pl-10 pr-4 text-sm outline-none transition-all focus-visible:ring-2 focus-visible:ring-accent"
        />
      </div>

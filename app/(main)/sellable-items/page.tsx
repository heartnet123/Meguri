    ...
    <div className="space-y-6 max-w-7xl mx-auto">
      ...
      <div className="rounded-2xl border border-border bg-surface p-4 shadow-sm relative">
        ...
        <input
          ...
          className="w-full rounded-xl border border-border bg-background pl-10 pr-4 py-2.5 text-sm outline-none transition-all focus:ring-2 focus:ring-accent focus:border-transparent"
        />
      </div>

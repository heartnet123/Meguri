    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
      <div className="bg-surface rounded-xl shadow-xl border border-border w-full max-w-sm overflow-hidden flex flex-col">
        <div className="p-6">
          ...
          <h2 className="text-lg font-semibold text-foreground text-center mb-2">เก็บสินค้านี้เข้าแฟ้ม</h2>
          <p className="text-sm text-muted text-center leading-relaxed">
            ต้องการเก็บ <strong className="text-foreground">{item.name}</strong> เข้าแฟ้มหรือไม่?
            สินค้านี้จะถูกซ่อนจากหน้าปฏิบัติการทั้งหมด แต่ประวัติการเคลื่อนไหวของสต็อกยังคงอยู่
            และสามารถค้นหาได้จากรายการที่เก็บเข้าแฟ้ม
          </p>

...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-background overflow-hidden text-foreground">
      {/* Navbar */}
      <nav
        className="fixed top-0 w-full bg-surface border-b border-border z-50"
        aria-label="เมนูนำทางหลัก"
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
          <div
            className="font-display font-medium tracking-tight text-xl flex items-center gap-2"
            aria-label="หน้าแรก SmartStock"
          >
          ...
          <div className="hidden md:flex space-x-2">
            <a
              href="#features"
              className="text-sm font-medium hover:text-accent transition-colors py-3 px-4 focus:outline-none focus-visible:ring-2 focus-visible:ring-accent rounded-lg"
            >
              ความสามารถ
            </a>
            <a
        ...
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 pb-24 text-center">
          ...
          >
            <motion.div
              ...
              className="inline-flex items-center gap-2 px-3 py-1 bg-subtle border border-border text-xs font-semibold text-accent tracking-wide uppercase"
            >
              <iconify-icon
            ...
            <motion.h1
              variants={slideUpVariants}
              className="font-display text-5xl md:text-8xl font-medium tracking-tighter leading-none"
            >
            ...
            >
              แพลตฟอร์มครบวงจรสำหรับเบเกอรี คาเฟ่ และร้านค้าปลีกขนาดเล็ก ติดตามสต็อกแบบเรียลไทม์ เชื่อมสูตรกับยอดขาย
              และใช้ AI คาดการณ์ความต้องการเพื่อไม่ให้ของสำคัญขาดสต็อก
            </motion.p>
            ...
            >
              <div className="flex w-full flex-col items-center justify-center gap-4 sm:flex-row">
                ...
                <a
                  href="#features"
                  className="w-full sm:w-auto bg-surface text-foreground border border-border px-8 py-4 text-sm font-semibold tracking-wide uppercase hover:bg-subtle transition-colors flex items-center justify-center gap-2"
                >
                  <iconify-icon
                ...
                <div className="col-span-12 sm:col-span-9 space-y-8">
                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-3 gap-6">
                    {[...Array(3)].map((_, i) => (
                      <div
                        key={i}
                        className="h-28 border border-border p-5 flex flex-col justify-between"
                      >
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-3xl mb-16 lg:mb-24">
              ...
              <p className="text-xl text-muted leading-relaxed">
                เลิกคาดเดาแล้วใช้ข้อมูลจริง
                แพลตฟอร์มของเราจะเชื่อมยอดขายเข้ากับวัตถุดิบคงคลังโดยตรงผ่านหน้าจอที่ชัดเจนและใช้งานง่าย
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-20 items-center">
              ...
              >
                <motion.div variants={slideUpVariants}>
                  <h2 className="font-display text-4xl md:text-5xl font-medium tracking-tight mb-6">
                    คาดการณ์ความต้องการด้วย AI
                  </h2>
                  <p className="text-background/70 text-xl leading-relaxed">
                    เราใช้โมเดลแมชชีนเลิร์นนิงขั้นสูงในการวิเคราะห์ยอดขายย้อนหลัง จับฤดูกาล
                    และคาดการณ์ความต้องการล่วงหน้าได้อย่างแม่นยำ
                  </p>
                </motion.div>
                      ...
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          ...
                          <div className="text-xs text-neutral-400">
                            สั่งเนยเพิ่ม 15 กก. วันนี้เพื่อรองรับความต้องการช่วงสุดสัปดาห์ ระยะเวลาจัดส่ง 2 วัน
                          </div>
                        </div>
                      </div>
                    </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 lg:mb-24 gap-8">
              <div className="max-w-2xl">
                <h2 className="font-display text-4xl md:text-5xl font-medium tracking-tight mb-6">
                  สร้างมาเพื่อธุรกิจของคุณ
                </h2>
                <p className="text-xl text-muted leading-relaxed">
                  ออกแบบมาเฉพาะสำหรับธุรกิจอาหารและค้าปลีกขนาดเล็กถึงขนาดกลาง
                </p>
              </div>
            </div>
      ...
      <footer className="bg-surface border-t border-border py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row justify-between items-center gap-8">
          ...
          <div className="flex gap-2">
            <a
              href="#"
              className="p-3 text-muted hover:text-foreground transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-foreground rounded-lg"
              aria-label="ติดตาม SmartStock บน Twitter"
            >
              <iconify-icon
            ...
            <a
              href="#"
              className="p-3 text-muted hover:text-foreground transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-foreground rounded-lg"
              aria-label="ดู SmartStock บน GitHub"
            >
              <iconify-icon
...
const audiences = [
  ...
  },
  {
    ...
    benefits: ["ตัดแป้งและเนยตาม BOM อัตโนมัติ", "วางแผนการผลิตของวันถัดไป", "ลดการสูญเสียวัตถุดิบ"],
  },
  {
    title: "ร้านค้าปลีกขนาดเล็ก",
    description: "รู้ชัดว่าสินค้าไหนขายดีและสินค้าไหนค้างสต็อก",
    benefits: ["ระบุสินค้าค้างสต็อกได้เร็ว", "รับคำแนะนำการสั่งซื้ออัตโนมัติ", "ติดตามระยะเวลาจัดส่งของซัพพลายเออร์"],
  },
];
